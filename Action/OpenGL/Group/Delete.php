...
/**
 * Action which deletes a group. Similar to the create action it only invokes the
 * group service to delete a specific group
 */
class Delete extends ActionAbstract
{
    ...
    public function handle(RequestInterface $request, ParametersInterface $configuration, ContextInterface $context)
    {
        ...
        try {
            ...
            $message->setMessage('Group successful deleted');
            $message->setId($id);
